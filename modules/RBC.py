...
class ROBERTA_BiGRU_CRF(nn.Module):
    def __init__(self, tag_to_ix, hidden_dim=768):
        super(ROBERTA_BiGRU_CRF, self).__init__()
        ...
        self.bert = RobertaModel.from_pretrained("./chinese_roberta_wwm_ext_pytorch/")
